...
<?php
										...
										case 'ip':
											echo '<a target="_blank" href="http://ipinfo.io/'.sanitize_text_field( $intrusion->ip ). '" >'.sanitize_text_field( $intrusion->ip ).'</a> <br/> '; //hassan
											...
											if ($intrusion->origin && strpos($intrusion->origin,'.')===false)
                                                	echo '<br/><a target="_blank" href="http://ipinfo.io/'.sanitize_text_field( $intrusion->ip ). '" >'.$intrusion->origin.' <img src="'.HMW_URL.'/img/flags/'. strtolower($intrusion->origin).'.gif" title="Country Code: '.$intrusion->origin.'"></a> ';
